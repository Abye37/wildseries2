 ...
 */
final class Version20191126083221 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program ADD poster VARCHAR(255) DEFAULT NULL, DROP category_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program ADD category_id INT NOT NULL, DROP poster');
