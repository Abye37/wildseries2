 ...
 */
final class Version20191203162435 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program ADD number INT NOT NULL, ADD year INT NOT NULL, ADD description LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program DROP number, DROP year, DROP description');
    }
}
